...
def build_local_problem_lp( pb,name):
    ...
    lp.setObjective( pb.electricity_tariff*pb.time_step_duration/60*pulp.lpSum([prod_vars[t]["payed_conso"]  for t in pb.time_steps])* pb.time_step_duration/60.0\
                   -pb.solar_power_selling_price*pb.time_step_duration/60*pulp.lpSum([prod_vars[t]["sold_local_production"] for t in pb.time_steps]) * pb.time_step_duration/60.0)
