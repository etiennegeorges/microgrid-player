...
def create_thermal_plant_lp( pb,name):
    ...
    for t in pb.time_steps:
        ...
        for reservoir in pb.reservoirs:
            ...
            #const_name="stock_min"+str(t)
            #lp+=volume_res[t][reservoir]>=0, const_name
        ...
        lp += pulp.lpSum([ prod_vars[t][thermal_plant] for thermal_plant in pb.thermal_plants ])+ pulp.lpSum([ prod_vars[t][hydro_plant] for hydro_plant in pb.hydro_plants ]) == pb.demand[t], constraint_name
